...
public class ParallelGravity : MonoBehaviour
{
    ...
    {
        if (other.gameObject.TryGetComponent<PlayerController>(out var gravityReceiver))
        {
            ...
            // Adjust the camera when entering gravity zone
            gravityReceiver.AdjustCameraOrientation(gravityDirection);
        }
    }
